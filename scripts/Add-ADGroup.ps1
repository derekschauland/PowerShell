## =====================================================================
## Title       : Add-ADGroup
## Description : Create Active Directory Group
## Author      : Idera
## Date        : 9/22/2008
## Input       : -server 
##               -domain
...
##               -debug   
## Output      : 
## Usage       : PS> .\Add-ADGroup -server localhost:389 -domain Idera -ou sales -group Management -verbose -debug
...
function main()
{
	...
	Write-Verbose "Creating an Active Directory Group..."
	Add-ADGroup $server $domain $ou $group
}

function Add-ADGroup($server,$domain,$ou,$group)
{
	trap [Exception] 
	{
	...
	$domainObj = [adsi]"LDAP://$server/ou=$ou,dc=$domain,dc=COM"
	Write-Debug "Domain object is LDAP://$server/ou=$ou,dc=$domain,dc=COM"
	
	$groupObj = $domainObj.Create("Group","CN=$group")
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUYg1hH3f9yoIihy+abjdslUky
# 91qggg92MIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFBuM
# JipaGKndVZ+e0DXc93XhbXFuMA0GCSqGSIb3DQEBAQUABIIBAFSBN81pi7oowKWh
# DFbKFO2nOFu2ukXTMFDZZmYagkiolTn7gSPJEE5kbzovJCVvqcQ3asHvDUhv0JHU
# dtpaX7TBuavewLi0RYJMzcSNpFr+UnxAWgfzl08ubTrtnhn5ZsKdJEmGxDVq2oV5
# FlnnlmPFYfsK1Y6ELZ9p8qc4auJXLOXhaNVpVGskYTVTVUf9q8VGFu+EyxN78FbO
# jVJlzVEF2nxNUhtV1OIdZGIhdHQ2qG2Ig/6P68zpztJtsKesxqmzXGmwDDlRa/xa
# o9H0f49tXRDDeoAz0BagvTpI6tDI22Nr8+4ppDRMjKRod5TL3sCYvke049goQ399
# kiieA2qhggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEwaDBSMQswCQYDVQQG
...
# CQUxDxcNMTQwNjI2MTQwMjI1WjAjBgkqhkiG9w0BCQQxFgQUW3XcRBPLUcpdKrYg
# O4WhOR+vSR8wgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGEBBSM5p9QEuHRqPs5
...
# LSBHMgISESFAXB8O0liIK+VNhoa6EepFMA0GCSqGSIb3DQEBAQUABIIBAH5tvize
# 2z2EiO1DPwkta8aDLTJmrcIvunPLFmnj58BlctQTuAkwhxhLDqPzhnnd5+u7KiX9
# Y/wVNL4k8+VdKhEW8Nsdr1W72JaEncRZH3DL2TSQiuc0Z5SNs64NxhzjgbMM+18N
# dGJUT7qH8XyTYtRWmFXkAvvMuPJSyPQG4vu7gSBQsaty7iFPX+MIwGrQc/jjCqzT
# BQ92KQ4Ugmmph6/RhEqS5bBFv2CYimoc5KpdMk4OfkmYhkwFWf1Q953oMStomQk9
# Nj5XEbTDev0tYZNntV9xDDG7fNyS9L21G0bCtzGZg6CjMqhj9D8qPdZlKlWg3N4k
# 2mmqCw34/BzSdw0=
